...
const paths: Record<IconName, string[]> = {
  ...
  columnAfter: ['M3 3h12v18H3V3zm6 2H5v14h4V5zm4 0h-2v14h2V5zm7 6v-3h-2v3h-3v2h3v3h2v-3h3v-2h-3z'],
  columnBefore: ['M9 3h12v18H9V3zm6 2h-4v14h4V5zm4 0h-2v14h2V5zM4 11V8h2v3h3v2H6v3H4v-3H1v-2h3z'],
  deleteColumn: ['M3 3h14v14H3V3zm6 2H5v10h4V5zm6 0h-4v10h4V5zm-7 15h8v2H8v-2z'],
  deleteRow: ['M3 3h18v14H3V3zm2 5h14V5H5v3zm0 7h14v-5H5v5zm3 5h8v2H8v-2z'],
  ...
  rowAfter: ['M3 3h18v12H3V3zm2 6v4h14V9H5zm0-4v2h14V5H5zm6 15v-3h2v3h3v2h-3v3h-2v-3H8v-2h3z'],
  rowBefore: ['M3 9h18v12H3V9zm2 6v4h14v-4H5zm0-4v2h14v-2H5zm6-7V1h2v3h3v2h-3v3h-2V6H8V4h3z'],
